...
const GenerateReports = () => {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      ...
      try {
        ...
        const response = await axios.get('http://localhost:8000/api/reports', config);
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Refresh report list
      const reportsResponse = await axios.get('http://localhost:8000/api/reports', config);
            ...
            return (
              <tr key={report.id}>
                ...
                <td className="border p-2">
                  {userData ? userData.name : `User ID: ${report.generated_by}`}
                </td>
                <td className="border p-2">
